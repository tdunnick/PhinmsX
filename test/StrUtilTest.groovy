...
public class StrUtilTest extends GroovyTestCase
{
	void testReplace()
	{
		String s = StrUtil.replace ("Hello you large Jello", "ll", "LL")
		assert s != null : "return null"
		assert s.equals ("HeLLo you large JeLLo") : "got " + s;
	}	
}
